    ...
    <div class="px-4 py-4">
      ...
      <div class="flex gap-2 mb-3 items-center">
        ...
        <button
          ...
          <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            <path stroke-linecap="round" stroke-linejoin="round" d="M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5L12 3zM18 14l1 3 3 1-3 1-1 3-1-3-3-1 3-1 1-3z" />
          </svg>
          Pametna lista
        </button>
      </div>
      ...
      @if (shoppingService.viewMode() === 'ai') {
        ...
        @if (shoppingService.aiError(); as error) {
          <div class="bg-red-50 border border-red-200 text-red-700 rounded-xl px-4 py-3 mb-3 text-sm" role="alert">
            {{ error }}
          </div>
        }
        ...
        @if (shoppingService.aiLoading()) {
          ...
          <div class="bg-white rounded-xl px-4 py-6 text-center">
            <p class="text-sm text-text-secondary mb-3">
              AI će spojiti slične sastojke, predložiti realne kupovne količine i grupisati ih po odeljenjima prodavnice.
            </p>
            <button
