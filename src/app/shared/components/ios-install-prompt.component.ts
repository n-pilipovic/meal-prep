      ...
      >
        ...
        >
          <div class="flex items-center justify-between mb-4">
            <h2 id="ios-install-title" class="text-lg font-bold text-text-primary">
          ...
          <ol class="space-y-4 mb-6">
            <li class="flex items-start gap-3">
              <span
                class="flex-shrink-0 w-8 h-8 bg-green-primary text-white rounded-full flex items-center justify-center text-sm font-bold"
                >1</span
              >
              <div>
                <p class="text-sm font-medium text-text-primary">Tapni na dugme za deljenje</p>
                <p class="text-xs text-text-secondary mt-0.5">
                  U Safari-ju, tapni na
                  <span class="inline-block text-base leading-none align-middle">⬆️</span> ikonu na
                  dnu ekrana
                </p>
              </div>
            </li>
            <li class="flex items-start gap-3">
              ...
              <div>
                ...
                <p class="text-xs text-text-secondary mt-0.5">
                  Skroluj dole u meniju ako ne vidiš opciju
                </p>
              </div>
            </li>
            <li class="flex items-start gap-3">
